...
// Write an if/else if/else statement to check which food you choose - if it's Italian, execute the first alert, if it's Curry,
//execute the second with the throw, or if it's Pub grub, execute the third
...
var drunk_guess = prompt("Will you swipe left or right?: (1)Right (2)Left");
if(drun == 1){
...
// Write an if/else statement including the or operator - if your age_guess is under 30 OR your drunk_guess is true, execute the first alert,
//but if NEITHER of those conditions are met, execute the second with the throw
...
// Write an if/else statement including the and operator - if your pay_choice is to Offer to pay AND the money_in_wallet is over or
//equal to 100, execute the first alert, but if EITHER of those conditions isn't met, execute the second with the throw
